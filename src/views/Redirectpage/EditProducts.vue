...
export default {
  ...
  created: function() {
    ...
    axios.get(`http://localhost:3000/api/products/${id}`).then(response => {
      ...
      if (this.list.specifications.length > 0) {
        for (let i = 0; i < this.list.specifications.length; i++) {
          //   this.specification.sp_detail_en = this.list.specifications[
          //     i
          //   ].sp_detail_en;
          //   this.specification[i].sp_name_ch = this.list.specifications[
          //     i
          //   ].sp_name_ch;
          //   this.specification[i].sp_detail_en = this.list.specifications[
          //     i
          //   ].sp_detail_en;
          //   this.specification[i].sp_name_en = this.list.specifications[
          //     i
          //   ].sp_name_en;
          // }
          this.specification.push(this.list.specifications[i]);
        }
        this.specification.splice(0, 1);
      }
      // this.specification = this.list.specification;
    });
  },
  methods: {
    ...
    async submitForm() {
      ...
      console.log(this.body.specifications);
      ...
      const id = this.$route.params.id;
      await axios
        .put(`http://localhost:3000/api/products/${id}`, this.body)
        .then(
